...
const MZ_STR = {
  ...
  'hero.cta2': { en: 'Bid on live auctions', ar: 'زايد على المزادات' },
  ...
  'aw.msg': { en: 'Message the winner', ar: 'راسل الفائز' },
  ...
  'stat.bids':    { en: 'prices placed', ar: 'عرض سعر مقدَّم' },
  ...
  'demo.note':    { en: 'This is a sample auction so you can see how it works. It disappears once real auctions exist.',
                    ar: 'هذا مزاد توضيحي لترى كيف تعمل المنصة. يختفي عند وجود مزادات حقيقية.' },

  'trust.h':    { en: 'Built so nobody has to trust anybody', ar: 'مصمّمة بحيث لا يحتاج أحد أن يثق بأحد' },
  'trust.1.t':  { en: 'No commission', ar: 'بدون عمولة' },
  'trust.1.d':  { en: 'Free. The platform takes nothing from the deal.', ar: 'مجانية. المنصة لا تأخذ شيئًا من الصفقة.' },
  'trust.2.t':  { en: 'No sign-up', ar: 'بدون تسجيل' },
  'trust.2.d':  { en: 'Post and bid straight from the phone. No accounts, no passwords.', ar: 'انشر وزايد من الجوال مباشرة. لا حسابات ولا كلمات مرور.' },
  'trust.3.t':  { en: 'Every price is public', ar: 'كل الأسعار معلنة' },
  'trust.3.d':  { en: 'All bidders see the same numbers at the same moment. No side deals.', ar: 'كل المتنافسين يرون الأرقام نفسها في اللحظة نفسها. لا صفقات جانبية.' },
  'trust.4.t':  { en: 'The winner is computed', ar: 'الفائز يُحسب لا يُختار' },
  'trust.4.d':  { en: 'Lowest complete price when the clock stops. Nobody can override it.', ar: 'أقل سعر كامل عند انتهاء الوقت. ولا يستطيع أحد تغييره.' },

  'sup.h':   { en: 'Supply building materials?', ar: 'مورّد مواد بناء؟' },
  'sup.d':   { en: 'Requests arrive ready — quantities, specs, delivery site. Open a live auction, see the price to beat, and take the deal at the lowest winning price.',
               ar: 'الطلبات تصلك جاهزة — كميات ومواصفات وموقع تسليم. افتح مزادًا مباشرًا، شاهد السعر المطلوب كسره، وخذ الصفقة بأقل سعر رابح.' },
  'sup.cta': { en: 'Browse live auctions', ar: 'تصفّح المزادات المباشرة' },

  'faq.h':   { en: 'Questions people actually ask', ar: 'الأسئلة التي تُسأل فعلًا' },
  'faq.1.q': { en: 'Who picks the winner?', ar: 'من يختار الفائز؟' },
  'faq.1.a': { en: 'Nobody. When the time is up, the lowest complete price wins automatically — the buyer cannot pick someone else, and that is exactly why suppliers bother competing.',
               ar: 'لا أحد. عند انتهاء الوقت يفوز أقل سعر كامل تلقائيًا — لا يستطيع المشتري اختيار غيره، وهذا بالضبط ما يجعل الموردين يتنافسون بجدية.' },
  'faq.2.q': { en: "Do suppliers see each other's prices?", ar: 'هل يرى الموردون أسعار بعضهم؟' },
  'faq.2.a': { en: 'Yes, live. That is the whole point: every supplier sees the price to beat, so the price keeps falling until the clock stops.',
               ar: 'نعم، مباشرة. هذه هي الفكرة كلها: كل مورد يرى السعر المطلوب كسره، فيستمر السعر بالنزول حتى ينتهي الوقت.' },
  'faq.3.q': { en: 'What does it cost?', ar: 'كم التكلفة؟' },
  'faq.3.a': { en: 'Nothing. No commission on deals, no fees, no paid plans.',
               ar: 'لا شيء. لا عمولة على الصفقات، ولا رسوم، ولا باقات مدفوعة.' },
  'faq.4.q': { en: 'Do I need an account?', ar: 'هل أحتاج إلى تسجيل؟' },
  'faq.4.a': { en: 'No. You post the request and send one link on WhatsApp; suppliers bid from their phones. Just keep your link — it is how you get back to your auction.',
               ar: 'لا. تنشر الطلب وترسل رابطًا واحدًا عبر واتساب، والموردون يزايدون من جوالاتهم. فقط احتفظ برابطك — فهو طريقك للعودة إلى مزادك.' },
  'faq.5.q': { en: 'How do I make sure the quality is right?', ar: 'كيف أضمن جودة المواد؟' },
  'faq.5.a': { en: 'You set the specification in the request — grade, size, standard, certificates — and every bid is a price for exactly that. The platform settles the price; inspection on delivery stays as it is in any purchase.',
               ar: 'أنت تحدد المواصفات في الطلب — الدرجة والمقاس والمعيار والشهادات — وكل عرض هو سعر لهذه المواصفات بالضبط. المنصة تحسم السعر؛ والفحص عند الاستلام يبقى كما في أي شراء.' },

  'foot.tag': { en: 'Lowest price wins — automatically.', ar: 'أقل سعر يفوز — تلقائيًا.' },
