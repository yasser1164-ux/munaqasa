...
const MZ_STR = {
  ...
  // ---- board ----------------------------------------------------------------
  'hero.h1':  { en: 'Stop buying from the first quote.', ar: 'لا تشترِ بأول عرض سعر.' },
  'hero.p':   { en: 'Post what the site needs — cement, rebar, ready-mix, blocks — and let suppliers bid against each other. Bids stay sealed until your closing time, then open together and are compared on <b>landed cost</b>: unit prices, delivery and VAT, not just the price per bag.',
                ar: 'انشر احتياج موقعك — أسمنت، حديد، خرسانة جاهزة، بلك — ودع الموردين يتنافسون على السعر. تبقى العروض مغلقة حتى موعد الإقفال، ثم تُفتح معًا وتُقارن على <b>التكلفة الواصلة</b>: أسعار الوحدات مع التوصيل والضريبة، لا سعر الكيس وحده.' },
  'hero.cta1': { en: '📋 Post a request', ar: '📋 اطرح طلبًا' },
  'hero.cta2': { en: '🔎 Bid on open requests', ar: '🔎 قدّم عرضًا على الطلبات' },
  ...
  'how2.t': { en: '2 · Sealed bids', ar: '٢ · عروض مغلقة' },
  'how2.d': { en: "Send one link to your suppliers. Nobody sees another supplier's price.", ar: 'أرسل رابطًا واحدًا لمورّديك. لا أحد يرى سعر غيره.' },
  'how3.t': { en: '3 · Compare & award', ar: '٣ · قارن ورسِّ' },
  'how3.d': { en: 'At closing time every bid opens at once, ranked on landed cost.', ar: 'عند الإقفال تُفتح كل العروض دفعة واحدة، مرتبة على التكلفة الواصلة.' },
  'sec.mine':  { en: 'Your activity', ar: 'نشاطك' },
  'sec.board': { en: 'Requests on the board', ar: 'الطلبات المطروحة' },
  ...
  'f.open':     { en: 'Open for bids', ar: 'مفتوح للعروض' },
  'f.closing':  { en: 'Closing today', ar: 'يُقفل اليوم' },
  'f.closed':   { en: 'Bids opened', ar: 'فُتحت العروض' },
  'f.awarded':  { en: 'Awarded', ar: 'تمت الترسية' },
  'f.allmats':  { en: 'All materials', ar: 'كل المواد' },
  'card.neededBy': { en: 'Needed on site by {d}', ar: 'مطلوب في الموقع قبل {d}' },
  'card.noBids':   { en: 'No bids received', ar: 'لم تصل عروض' },
  'card.best':     { en: '{bids} · best {p}', ar: '{bids} · الأفضل {p}' },
  ...
  'status.closing': { en: 'CLOSING', ar: 'يُقفل' },
  'status.closed':  { en: 'BIDS OPENED', ar: 'فُتحت العروض' },
  'status.awarded': { en: 'AWARDED', ar: 'تمت الترسية' },
  'status.short.closed': { en: 'Closed — comparing', ar: 'أُقفل — للمقارنة' },
  ...
  'p.sub': { en: 'Suppliers bid line by line, sealed until your closing time. The more exact the specification, the less room there is to quote you something cheaper than what you asked for.',
             ar: 'يقدّم الموردون أسعارهم بندًا ببند، مغلقةً حتى موعد الإقفال. كلما دقّت المواصفات، ضاق المجال لتسعير شيء أرخص مما طلبت.' },
  ...
  'p.window':   { en: 'Bidding window', ar: 'فترة العروض' },
  'p.window.d': { en: 'Nobody — you included — can see a price before this moment. At closing time every bid opens at once.',
                  ar: 'لا أحد — ولا حتى أنت — يرى سعرًا قبل هذا الموعد. عند الإقفال تُفتح كل العروض دفعة واحدة.' },
  'p.closes': { en: 'Bids close at', ar: 'تُقفل العروض في' },
  ...
  'p.submit':  { en: 'Post request & get the supplier link', ar: 'انشر الطلب واحصل على رابط الموردين' },
  ...
  'fact.closes':  { en: 'Bids close', ar: 'إقفال العروض' },
  'fact.bids':    { en: 'Bids', ar: 'العروض' },
  'fact.site':    { en: 'Delivery site', ar: 'موقع التسليم' },
  'fact.awarded': { en: 'Awarded', ar: 'تمت الترسية' },
  'fact.sealed':  { en: '{n} sealed', ar: '{n} مغلقة' },
  'fact.opened':  { en: '{n} opened', ar: '{n} مفتوحة' },
  ...
  'share.d':  { en: 'One link, as many suppliers as you like. They bid without seeing each other.',
                ar: 'رابط واحد لأي عدد من الموردين. يقدّمون عروضهم دون أن يرى أحدهم الآخر.' },
  ...
  'share.text': { en: '{ref} — {title}\n{city} · needed on site by {d}\n\n{lines}\n\nSealed bids close {t}. Send your price here:',
                  ar: '{ref} — {title}\n{city} · مطلوب في الموقع قبل {d}\n\n{lines}\n\nالعروض مغلقة وتُقفل {t}. أرسل سعرك هنا:' },

  'bid.h.new': { en: 'Send your bid', ar: 'أرسل عرضك' },
  'bid.h.rev': { en: 'Revise your bid', ar: 'عدّل عرضك' },
  'bid.d': { en: 'Prices exclude VAT and are per unit. Leave a line empty if you do not carry it — partial bids still compete line by line.',
             ar: 'الأسعار للوحدة وبدون الضريبة. اترك البند فارغًا إن كنت لا توفّره — العروض الجزئية تظل تنافس بندًا ببند.' },
  ...
  'bid.send':    { en: 'Send sealed bid', ar: 'أرسل العرض المغلق' },
  'bid.sendRev': { en: 'Send revised bid', ar: 'أرسل العرض المعدّل' },
  'bid.sending': { en: 'Sending…', ar: 'جارٍ الإرسال…' },
  'bid.sealedHint': { en: 'Your price is sealed until {t} — the buyer sees only that a bid arrived. You can revise it any time before then.',
                      ar: 'سعرك مغلق حتى {t} — لا يرى المشتري إلا أن عرضًا وصل. ويمكنك تعديله في أي وقت قبل ذلك.' },
  ...
  'cmp.h': { en: 'Bids opened — ranked on landed cost', ar: 'فُتحت العروض — مرتبة على التكلفة الواصلة' },
  'cmp.d': { en: 'Landed cost is unit prices × quantities, plus delivery, minus any discount, plus {p}% VAT. Partial bids sit below the complete ones; they still compete line by line further down.',
             ar: 'التكلفة الواصلة = أسعار الوحدات × الكميات، زائد التوصيل، ناقص الخصم، زائد {p}% ضريبة. العروض الجزئية تحت الكاملة، وتظل تنافس بندًا ببند في الأسفل.' },
  ...
  'posted.live': { en: '✅ <b>{ref} is live.</b> Send the link below to every supplier you would normally call. Their prices stay sealed until {t}.',
                   ar: '✅ <b>{ref} أصبح منشورًا.</b> أرسل الرابط أدناه لكل مورد كنت ستتصل به. تبقى أسعارهم مغلقة حتى {t}.' }
};
